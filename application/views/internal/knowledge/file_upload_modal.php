<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" id= "KMUpload1">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                         ...
                         <div class="modal-body">
                          ...
                          <form class="form-horizontal form-label-left" enctype="multipart/form-data" method = "post" action="<?php echo(base_url())?>Knowledge/do_file_upload/">
                          
                          <div class="form-group row ">
                            <label class="control-label col-md-3 col-sm-3 ">File<span class="required-field"></span></label>
