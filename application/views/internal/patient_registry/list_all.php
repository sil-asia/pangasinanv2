                    ...
                    <table id="datatable" data-display-length='-1' class="table table-striped table-bordered" style="width:100%">
                      ...
                      <thead>
                                        ...
                                        <tbody>
                                            ...
                                            {?>
                                                <tr>
                                                    <td> <a href = "<?php echo(base_url()."Patient_registry/view/". $patient->id)?>"><?php echo($patient->last_name) ?></a> </td>
                                                    <td>  <?php echo $patient->first_name .", ". $patient->suffix ?> </td>
                                                    <td>  <?php echo $patient->middle_name; ?> </td>
                                                    <td>  <?php echo $patient->philhealth_no; ?> </td>
                                                    

                                                    <td>  <?php 
                                                    if($patient->profiled == 1) {
                                                    ...
                                                    else
                                                    {
                                                      ...
                                                      <td> <?php echo($patient->date_profiled)?></td>
                                                    
                                                <td>  <a><i class = 'fa fa-trash' id='delB2' onClick = "myfunction('<?php echo ($patient->id);?>')" > </i></a></td> 
                                                </tr>
