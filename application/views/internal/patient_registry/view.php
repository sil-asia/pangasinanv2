        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-13 ">
                    ...
                    <div class="x_panel">
                              ...
                              <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo(base_url().'Patient_Registry/list_all')?>" >Patients</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo($patient->last_name.", ".$patient->first_name)?></li>
                              </ol>
                            </nav>
                    ...
                    <ul class="nav nav-tabs bar_tabs" id="productTab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" id="productTab" data-toggle="tab" href="#info" role="tab" aria-controls="home" aria-selected="true">Patient Details</a>
                      </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <?php $this->load->view('internal/patient_registry/view-tabs/info_tab');?>
