                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" data-display-length='-1' class="table table-striped table-bordered" style="width:100%">
                      ...
                      <thead>
                                            <tr>
                                                <th>
                                                    Health Worker Last Name
                                                </th>
                                                <th>
                                                    Health Worker First Name
                                                </th>
                                                <th>
                                                    Health Worker Middle Name
                                                </th>
                                        ...
                                        <tbody>
                                            <?php foreach($hwr as $worker)
                                            {?>
                                                <tr>
                                                    <td> <a href = "<?php echo(base_url()."Health_worker_registry/view/". $worker->id)?>"><?php echo($worker->last_name) ?></a> </td>
                                                    <td>  <?php echo $worker->first_name .", ". $worker->suffix ?> </td>
                                                    <td>  <?php echo $worker->middle_name; ?> </td>
                                                    <td>  <?php echo $worker->philhealth_no; ?> </td>
                                                    ...
                                                    else
                                                    {
                                                      ...
                                                      <td> <?php echo($worker->approved_date)?></td>
                                                    
                                                <td>  <a><i class = 'fa fa-trash' id='delB2' onClick = "myfunction('<?php echo ($worker->id);?>')" > </i></a></td> 
                                                </tr>
