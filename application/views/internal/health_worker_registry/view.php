        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-13 ">
                    ...
                    <div class="x_panel">
                              ...
                              <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo(base_url().'Health_worker_Registry/list_all')?>" >Health Worker Registry</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo($hwr->last_name.", ".$hwr->first_name)?></li>
                              </ol>
                            </nav>
                    ...
                    <ul class="nav nav-tabs bar_tabs" id="productTab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" id="productTab" data-toggle="tab" href="#info" role="tab" aria-controls="home" aria-selected="true">Health Worker Details</a>
                      </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <?php $this->load->view('internal/health_worker_registry/view-tabs/info_tab');?>
