<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" id= "fileUpdate">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                         ...
                         <div class="modal-body">
                          ...
                          <form class="form-horizontal form-label-left" enctype="multipart/form-data" method = "post" action = <?php echo $file_action_update; ?> >
