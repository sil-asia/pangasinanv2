<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" id= "imageUpload">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                         ...
                         <div class="modal-body">
                          ...
                          <form class="form-horizontal form-label-left" enctype="multipart/form-data" method = "post" action= <?php echo($image_action);?> ?>
                             ...
                             <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-sm-9 ">
                                                <select tabindex="1" data-placeholder="Select here.." id = "file_tag" name = "file_tag" class="form-control">
                                                    <?php foreach ($dd_image_tag as $option)
                                                    {
                                                        echo ("<option value = ");
